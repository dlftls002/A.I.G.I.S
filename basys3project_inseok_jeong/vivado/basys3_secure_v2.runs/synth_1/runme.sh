...
HD_PWD='D:/260807_AIGIS_inseok/basys3project_inseok_jeong/vivado/basys3_secure_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_secure_rack_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_secure_rack_control.tcl
