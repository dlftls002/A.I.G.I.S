...
HD_PWD='D:/260807_AIGIS_inseok/basys3project_inseok_jeong/vivado/basys3_secure_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_secure_rack_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_secure_rack_control.tcl -notrace
