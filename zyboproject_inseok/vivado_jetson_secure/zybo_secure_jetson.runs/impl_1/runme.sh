...
HD_PWD='D:/260805_AIGIS_inseok/zyboproject_inseok/vivado_jetson_secure/zybo_secure_jetson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_secure_control_unit_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_secure_control_unit_v2.tcl -notrace
