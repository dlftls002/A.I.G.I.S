...
HD_PWD='D:/260805_AIGIS_inseok/zyboproject_inseok/vivado_jetson_secure/zybo_secure_jetson.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_secure_control_unit_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_secure_control_unit_v2.tcl
